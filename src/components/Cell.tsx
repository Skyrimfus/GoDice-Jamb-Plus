...
export default function Cell({ id, selectedCell, playable, text, dice, maxValue,secondMaxValue, bonus, rowID, bCanWrite, ticketData, onClick}: CellProps) {
    let classes = " ";
   ...
   if (!playable) bIsHint = false;
    ...
    const getSum = (row:string):number=>{
        ...
        switch(row){
            ...
            case "sum3":
                ...
                return sum3;
            case "sum4":
                return getSum("sum1")+getSum("sum2")+getSum("sum3");
            default:
                return 0;
